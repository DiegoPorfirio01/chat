    ...
    >
      <div className="space-y-6 text-center lg:text-start">
        <main className="text-6xl font-bold md:text-6xl">
          <h1 className="ml-8 animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-foreground bg-gradient-to-r from-[#000DFB] to-[#D247BF] bg-clip-text pr-5 text-transparent sm:ml-16 sm:max-w-72">
            Chat Lucy
          </h1>
